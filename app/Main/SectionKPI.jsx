            ...
            <div className="kpi-content">
                <div className="textbox">
                    <div className="subheadline-box opacity-blur" ref={subheadlineBoxRef} >
                        ...
                        <h2 className="small-description grey" >Career Achievements</h2>
                    </div>
                    <div className="titlebox">
                        <div className="titlebox-gradient" />
                        <h1 className="subheadline white" ref={titleRef} >Impact Through Innovation</h1>
                    </div>
                </div>
                <div className="kpi-content-row">
                        ...
                        <div className="kpi-item-textbox">
                            <div className="kpi-item-textbox-top">
                                <div className="kpi-item-textbox-number">
                                    <h2 className="headline kpi-item-textbox-number-text white" >7+</h2>
                                    <div className="kpi-item-textbox-number-gradient" />
                                </div>
                                <h3 className="small-subheadline kpi-item-textbox-top-text white" >years</h3>
                            </div>
                            <p className="description grey" >of professional software <br /> development experience</p>
                        </div>
                    ...
                    <div className="kpi-content-item" ref={bentoBoxRef2} >
                        <div className="kpi-item-textbox">
                            <div className="kpi-item-textbox-top">
                                ...
                                <h3 className="small-subheadline kpi-item-textbox-top-text white" >projects</h3>
                            </div>
                            <p className="description grey" >delivered across diverse industries <br /> from startups to enterprise</p>
                        </div>
                        <div className="kpi-item-button" >
                    ...
                    <div className="kpi-content-item" ref={bentoBoxRef3} >
                        <div className="kpi-item-textbox">
                            <div className="kpi-item-textbox-top">
                                <div className="kpi-item-textbox-number">
                                    <h2 className="headline kpi-item-textbox-number-text white" >40%</h2>
                                    <div className="kpi-item-textbox-number-gradient" />
                                </div>
                                <h3 className="small-subheadline kpi-item-textbox-top-text white" >improvement</h3>
                            </div>
                            <p className="description grey" >average performance gains <br /> through optimization and automation</p>
                        </div>
                        <div className="kpi-item-button" >
