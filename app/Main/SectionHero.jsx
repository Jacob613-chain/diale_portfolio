      ...
      <div className="hero-content">
            ...
            <div className="hero-buttons-row">
              <button className="button button-transparent-border opacity-blur" ref={buttonRef1} onClick={handleViewProjects} >
                <div className="button-content">
                  <span className="small-description">View Projects</span>
                  <span className="small-description">View Projects</span>
                </div>
              ...
              <button className="button button-transparent-border opacity-blur" ref={buttonRef2} onClick={handleContactMe} >
                <div className="button-content">
                  <span className="small-description">Contact Me</span>
                  <span className="small-description">Contact Me</span>
                </div>
        ...
        <div className="hero-content-bottom opacity-blur" ref={logosWrapperRef} >
          <Marquee className="hero-content-bottom-row" gradient={true} gradientColor="#010101" gradientWidth={250}>
            {[
              "/logos/salesforce-logo.svg",
              "/logos/hubspot-logo.svg",
              "/logos/n8n-logo.svg",
              "/logos/make-logo.svg",
              "/logos/zapier-icon-svgrepo-com.svg",
              "/logos/blender.svg",
              "/logos/wordpress-icon.svg",
              "/logos/shopify-icon.svg",
              "/logos/node-logo.svg",
              "/logos/react-logo.svg",
              "/logos/cloudflare-color.svg",
              "/logos/perplexity-logo.svg",
              "/logos/workersai-logo.svg",
              "/logos/huggingface-color.svg",
              "/logos/snowflake-color.svg",
              "/logos/stripe.svg",
              "/logos/nextjs.svg",
              "/logos/vscode.svg",
            ].map((src, i) => (
              <div className="hero-content-bottom-item" key={i}>
                <Image width={100} height={100} src={src} alt={`Technology ${i + 1}`} className="hero-content-bottom-image" />
              </div>
            ))}
          </Marquee>
        </div>
