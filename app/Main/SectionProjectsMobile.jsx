    ...
    <section className="projects projects-mobile">
      <div className="textbox">
        <div className="subheadline-box opacity-blur" ref={subheadlineBoxRef} >
          ...
          <h2 className="small-description grey" >Portfolio Projects</h2>
        </div>
        ...
        <p className="description grey" ref={descriptionRef} >From e-commerce platforms to AI-powered applications, <br className="hide-on-desktop" /> creating scalable solutions for diverse industries.</p>
      </div>
